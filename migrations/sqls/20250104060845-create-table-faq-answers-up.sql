...
create index if not exists idx_faq_answers_faq_id on faq_answers (faq_id);
create index if not exists idx_faq_answers_created_at on faq_answers (created_at);
